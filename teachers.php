<?php
    ...
    $teachers = @$stmt->fetchAll(PDO::FETCH_CLASS, 'Teacher');
    ...
    <section class="h-100 mt-5">
        <div class="card w-100 bg-transparent text-light text-center border border-light">
            <div class="card-title text-start p-3 d-flex justify-content-between" style="align-items: baseline;">
                <h1>Teachers</h1>
                <a href="teachers-create.php" class="btn btn-success">Add Teacher <i class="fa fa-plus"></i></a>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($teachers as $teacher): ?>
                            <tr>
                                ...
                                <td><?= $teacher->email ?></td>
                                <td><?= $teacher->phone ?></td>
                                <td><img src="<?= $teacher->picture ?>" alt="profile image"></td>
                                <td>
                                    <a href="teachers-edit.php" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                    <a href="teachers.php?action=delete&id=<?= $teacher->id ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
